...
<form action="{{route('user_info.update',['user' => $user])}}" method="post">
    ...
    <div class="form-input">
        ...
        <input name="last_name" type="text"
            value="{{old('last_name',$request -> last_name)}}" class="new-value" readonly>
        @endif
    </div>
    <div class="form-input">
        名：
        ...
        <input name="first_name" type="text"
            value="{{old('first_name',$request -> first_name)}}" readonly>
        @endif
    </div>
    <div class="form-input">
        氏(カナ)：
        ...
        <a class="arrow-mark">→</a>
        <input name="last_name_kana" type="text"
            value="{{old('last_name_kana',$request -> last_name_kana)}}" class="new-value" readonly>
        @endif
    </div>
    <div class="form-input">
        名(カナ)：
        ...
        <input name="first_name_kana" type="text"
            value="{{old('first_name_kana',$request -> first_name_kana)}}" readonly>
        @endif
    </div>
    ...
    <div class="form-input">
        ...
        <input name="gender" type="text"
            value="{{old('gender',$request -> gender)}}" class="new-value" readonly>
        @endif
    </div>$
    <div class="form-input">
        生年月日：
        ...
        <div>
            ...
            <input name="birth_year" type="text"
                value="{{old('birth_year',$request -> birth_year)}}" class="new-value" readonly>年
            @else
            <input name="birth_year" type="hidden"
                value="{{old('birth_year',$birth_year_comparison)}}" class="new-value" readonly>
        ...
        <div>
            ...
            <a class="arrow-mark">→</a>
            <input name="birth_month" type="text"
                value="{{old('birth_month',$request -> birth_month)}}" class="new-value" readonly>月
            @else
            <input name="birth_month" type="hidden"
                value="{{old('birth_month',$birth_month_comparison)}}" class="new-value" readonly>
            @endif
        </div>
        <div>
            ┗日：
            ...
            <a class="arrow-mark">→</a>
            <input name="birth_day" type="text"
                value="{{old('birth_day',$request -> birth_day)}}" class="new-value" readonly>日
            @else
            <input name="birth_day" type="hidden"
                value="{{old('birth_day',$birth_day_comparison)}}" class="new-value" readonly>
    ...
    <div class="form-input">
        ...
        <div>
            ...
            <input name="post_code" type="text"
                value="{{old('post_code',$request -> post_code)}}" class="new-value" readonly>
            @endif
        </div>
        <div>
            ┗住所1：
            ...
            <input name="address1" type="text"
                value="{{old('address1',$request -> address1)}}" class="new-value" readonly>
            @endif
        </div>
        <div>
            ┗住所2：
            ...
            <input name="address2" type="text"
                value="{{old('address2',$request -> address2)}}" class="new-value" readonly>
            @endif
        </div>
        <div>
            ┗住所3：
            ...
            <input name="address3" type="text"
                value="{{old('address3',$request -> address3)}}" class="new-value" readonly>
            @endif
        </div>
    </div>
    ...
    <div>
        ...
        <div>
            ...
            <a class="arrow-mark">→</a>
            <input name="join_year" type="text"
                value="{{old('join_year',$request -> join_year)}}" class="new-value" readonly>年
            @else
            <input name="join_year" type="hidden"
                value="{{old('join_year',$join_year_comparison)}}" class="new-value" readonly>
        ...
        <div>
            ...
            <a class="arrow-mark">→</a>
            <input name="join_month" type="text"
                value="{{old('join_month',$request -> join_month)}}"
                class="new-value" readonly>月
            @else
            <input name="join_month" type="hidden"
                value="{{old('join_month',$join_month_comparison)}}"
                class="new-value" readonly>
        ...
        <div>
            ...
            <a class="arrow-mark">→</a>
            <input name="join_day" type="text" value="{{old('join_day',$request -> join_day)}}"
                class="new-value" readonly>日
            @else
            <input name="join_day" type="hidden" value="{{old('join_day',$join_day_comparison)}}"
                class="new-value" readonly>
