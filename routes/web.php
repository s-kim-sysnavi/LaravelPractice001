...
Route::prefix('/user-info')->name('user_info.')->middleware('auth')->group(function () {
    ...
    Route::match(['get', 'post'], '/update-confirm/{user}', [
    ...
    Route::get('/profile-image/{user}', [
        UserController::class,
        'profile_image'
    ])->name('profile_image');
    Route::post('/profile-image/{user}', [
        UserController::class,
...
Route::get('user-info/create', [
    UserController::class,
    'create'
])->name('user_info.create')->middleware('guest');
Route::post(
    'user-info/create',
    [UserController::class, 'store']
)->name('user_info.store');
